...
namespace DataPie
{
    public partial class login : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            sc.MachineName = cboServerName.Text;
            ...
            else if (false)//sc.Status != System.ServiceProcess.ServiceControllerStatus.Running)
            {
            ...
            {
                _DBConfig.ServerName = "127.0.0.1";
            }
            else
            {
        ...
        private void DataPieOnLoad()
        {
            ...
            cboValidataType.SelectedIndex = 1;
        ...
        private void btnTestConn_Click(object sender, EventArgs e)
        {
            ...
            _conString = GetConstring(_DBConfig);
            _DBConfig.DB = new DBUtility.DbHelperOleDb(_conString);
            MainfromShow();
            this.Hide();
        ...
        private void btnOracLogin_Click(object sender, EventArgs e)
        {
            ...
            else 
            {
              ...
              ";Data Source=" + comboBox2.Text.ToString().Trim();
                _DBConfig.DB = new DBUtility.DbHelperOra(connectionString);
